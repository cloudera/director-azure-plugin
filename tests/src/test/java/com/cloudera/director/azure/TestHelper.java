...
public class TestHelper {
  ...
  private static final String TEST_SSH_PUBLIC_KEY = getSshKey(LIVE_TEST_SSH_PUBLIC_KEY_PATH);
  public static final String TEST_SSH_PRIVATE_KEY = getSshKey(LIVE_TEST_SSH_PRIVATE_KEY_PATH);
  ...
  public static AzureCredentials getAzureCredentials() {
    ...
    // pull the rest of the fields from command line parameters
    map.put(AzureCredentialsConfiguration.SUBSCRIPTION_ID.unwrap().getConfigKey(), LIVE_TEST_SUBSCRIPTION_ID);
  ...
  public static Map<String, String> buildTagMap() {
    ...
    tags.put("owner", "Cloudera Director Azure Plugin Live Test");
  ...
  public static Map<String, String> buildValidDirectorLiveTestMap() {
    ...
    // Pull provider configs from system / command line or use the defaults from
